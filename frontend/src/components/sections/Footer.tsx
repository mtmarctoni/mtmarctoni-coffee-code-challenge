...
export const Footer = () => {
  return (
    <footer className="relative bg-bg text-text overflow-hidden">
      ...
      <BeansScatter count={30} size={200} seed={50} y0={50} className="md:hidden hidden 2xl:block"/>
      <BeansScatter count={20} size={200} seed={50} y0={50} className="md:block hidden 2xl:hidden"/>
      ...
      <BeansScatter count={25} size={200} seed={150} y0={15} className="z-10 md:hidden hidden 2xl:block"/>
      <BeansScatter count={15} size={200} seed={150} y0={15} className="z-10 md:block hidden 2xl:hidden" />
